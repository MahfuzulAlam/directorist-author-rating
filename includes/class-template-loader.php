<?php
/**
 * Template resolution for Directorist Author Rating.
 *
 ...
 */
final class Directorist_Author_Rating_Template_Loader {
	...
	public static function extension_path( $template_name ) {
		...
		return DIRECTORIST_AUTHOR_RATING_DIR . 'templates/' . $template_name . '.php';
	}
