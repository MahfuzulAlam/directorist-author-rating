...
$directorist_author_rating       = (float) get_user_meta( $author_id, 'directorist_rating', true );
$directorist_author_review_count = absint( get_user_meta( $author_id, 'directorist_review_count', true ) );
            ...
            <div class="directorist-single-author-avatar">
                ...
                <div class="directorist-single-author-name">
                    ...
                    <?php if ( function_exists( 'directorist_is_review_enabled' ) && directorist_is_review_enabled() ) : ?>
                        <span class="directorist-single-author-rating">
                            <?php directorist_icon( 'fas fa-star' ); ?>
                            <span class="directorist-single-author-rating-value"><?php echo esc_html( number_format_i18n( $directorist_author_rating, 1 ) ); ?></span>
                            <span class="directorist-single-author-rating-count"><?php echo esc_html( $directorist_author_review_text ); ?></span>
                        </span>
                    <?php endif; ?>
                </div>
